...
void keyPressed()
{
  ...
  if (!streaming) {
    if (keyCode == UP) port.write("G21/G90/G1 X-40  F3500\n");
    if (keyCode == DOWN ) port.write("G21/G90/G1 X40 F3500\n");
    if (keyCode == LEFT) port.write("G21/G90/G1 Y40 F3500\n");
    if (keyCode == RIGHT) port.write("G21/G90/G1 Y-40 F3500\n");
